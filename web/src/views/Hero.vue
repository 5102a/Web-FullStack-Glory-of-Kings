<template>
  <div class="page-hero" v-if="model">
        ...
        <div class="info text-white p-3 d-flex h-100 flex-column jc-end">
          ...
          <div class="d-flex jc-between pt-2">
            <div class="scores d-flex ai-center" v-if="model.scores">
              ...
              <span>攻击</span>
              <span class="badge bg-grey-1">{{ model.scores.attack }}</span>
              <span>生存</span>
              <span class="badge bg-dark-1">{{ model.scores.survive }}</span>
            </div>
            <router-link to="/" tag="span" class="text-light-1 fs-sm">
              皮肤：2 &gt;
            </router-link>
          </div>
        </div>
    ...
    <div class="px-3 bg-white">
      <div
        class="nav d-flex jc-around 
       border-bottom pt-3 pb-2"
      >
    ...
    <swiper>
      <swiper-slide>
        <div>
          ...
          <m-card plain icon="reorder" title="出装推荐" class="hero-items">
          ...
          <m-card plain icon="reorder" title="使用技巧">
            <p class="m-0">{{ model.usageTips }}</p>
          </m-card>
          <m-card plain icon="reorder" title="对抗技巧">
            <p class="m-0">{{ model.battleTips }}</p>
          </m-card>
          <m-card plain icon="reorder" title="团战思路">
            <p class="m-0">{{ model.teamTips }}</p>
          </m-card>
          <m-card plain icon="reorder" title="英雄关系">
